                                                    ...
                                                    <table className="display cell-border" id="export-button">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td className="sorting_1">
                                                                    <div className="media"><img className="rounded-circle img-30 mr-3" src="assets/images/user/9.jpg" alt="Generic placeholder image" />
                                                                        <div className="media-body align-self-center">
                                                                            <div><a href="studentprofile.html"><strong>Bhavna Rajpoot</strong></a> <br />9876543210 <br />students@gmail.com</div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>20 Apr 2022, 09:24:21 AM</td>
                                                                <td><button className="btn btn-primary btn-xs"><i className="icon-printer"></i> </button></td>
                                                            </tr>
                                                            <tr>
                                                                <td className="sorting_1">
                                                                    <div className="media"><img className="rounded-circle img-30 mr-3" src="assets/images/user/9.jpg" alt="Generic placeholder image" />
                                                                ...
                                                                <td>Website</td>
                                                                <td><i className="icofont icofont-cur-rupee"></i>3500</td>
                                                                <td>20 March 2022, 09:24:21 AM</td>
                                                                <td><button className="btn btn-primary btn-xs"><i className="icon-printer"></i> </button></td>
                                                            </tr>
