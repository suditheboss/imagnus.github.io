                                    ...
                                    <div className="col-sm-12">
                                        <div className="card">
                                            <div className="card-body">
                                                <form className="theme-form e-commerce-form row mb-40">
                                                    ...
                                                    <div className="col-xl-2">
                                                        <button className="btn btn-info-gradien btn-pill" type="button" data-original-title="btn btn-info-gradien" title="">Submit</button>
                                                    </div>
                                                </form>
                                                <div className="user-status cart-table table-responsive mt-20">
                                                    <table className="table table-border">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><strong>MPPSC Mains (Hindi)</strong></td>
                                                                <td>560</td>
                                                                <td>85</td>
                                                                <td>46</td>
                                                                <td>1290 students</td>
                                                            ...
                                                            <tr>
                                                                <td><strong>MPPSC Prelims Bilingual (Target Batch 2021)</strong></td>
                                                                <td>560</td>
                                                                <td>85</td>
                                                                <td>46</td>
                                                                <td>1290 students</td>
                                                            ...
                                                            <tr>
                                                                <td><strong>Special MP GK</strong></td>
                                                                <td>560</td>
                                                                <td>85</td>
                                                                <td>46</td>
                                                                <td>1290 students</td>
