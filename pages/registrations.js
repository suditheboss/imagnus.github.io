                                    ...
                                    <div className="col-sm-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h5>Student Registrations (Total 6155 entries)</h5>
                                            </div>
                                                    ...
                                                    <table className="display cell-border" id="export-button">
                                                        ...
                                                        <tbody>
                                                            <tr role="row" className="odd text-center">
                                                                ...
                                                                <td>Website</td>
                                                                <td>01-02-2022 <br />12:17:25 AM</td>
                                                            </tr>
                                                            ...
                                                            <tr role="row" className="odd text-center">
                                                                <td className="sorting_1">
                                                                    <div className="media"><img className="rounded-circle img-30 mr-3" src="assets/images/user/9.jpg" alt="Generic placeholder image" />
                                                                        <div className="media-body align-self-center">
                                                                            <div><a href="studentprofile.html"><strong>Sanjay Singh Rajpoot</strong></a> <br />studentname@gmail.com</div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>9876543210 </td>
                                                                <td>UPSC Civil Services </td>
                                                                <td>Indore, Madhya Pradesh</td>
                                                                <td>Application</td>
                                                                <td>01-02-2022 <br />12:17:25 AM</td>
                                                            </tr>
