                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 breadcrumb-right">
                                            <ol className="breadcrumb">
                                                ...
                                                <li className="breadcrumb-item">Support Tickets</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <div className="row">
                                                    <div className="col-xl-4 col-sm-6 box-col-6">
                                                        <div className="card ecommerce-widget">
                                                            <div className="pd-35 support-ticket-font">
                                                                <div className="row">
                                                                    <div className="col-12"><span>Total Tickets</span>
                                                                        <span className="badge badge-pill badge-danger text-white">New (10)</span>
                                                                        <h3 className="total-num counter">256</h3>
                                                                    </div>
                                                    ...
                                                    <div className="col-xl-4 col-sm-6 box-col-6">
                                                        <div className="card ecommerce-widget">
                                                            <div className="pd-35 support-ticket-font">
                                                                <div className="row">
                                                                    <div className="col-12"><span>Resloved</span>
                                                                        <h3 className="total-num counter">143</h3>
                                                                    </div>
                                                    ...
                                                    <div className="col-xl-4 col-sm-6 box-col-6">
                                                        <div className="card ecommerce-widget">
                                                            <div className="pd-35 support-ticket-font">
                                                                <div className="row">
                                                                    <div className="col-12"><span>Pending</span>
                                                                        <h3 className="total-num counter">20</h3>
                                                                    </div>
                                                    ...
                                                    <table className="display cell-border" id="export-button">
                                                        ...
                                                        <tbody>
                                                            <tr className="text-center">
                                                                ...
                                                                <td>I have given test 1 but now I cannot find it@aposs results and my ranking</td>
                                                                <td><strong className="text-success">Resolved <br />01-02-2022 12:17:25 AM</strong></td>
                                                            </tr>
                                                            ...
                                                            <tr className="text-center">
                                                                ...
                                                                <td>01-02-2022 12:17:25 AM</td>
                                                                <td>I have given test 1 but now I cannot find it@aposs results and my ranking</td>
                                                                <td><strong className="text-danger">Pending</strong></td>
                                                            </tr>
