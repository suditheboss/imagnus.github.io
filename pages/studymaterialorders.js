                            ...
                            <Script id="result-template" type="text/x-handlebars-template">
                                <div className="ProfileCard u-cf">
                                    ...
                                    <div className="ProfileCard-details">
                                        <div className="ProfileCard-realName">Sudipt</div>
                                    </div>
                                </div>
                            </Script>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 breadcrumb-right">
                                            <ol className="breadcrumb">
                                                ...
                                                <li className="breadcrumb-item">Study Material Orders</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h5>Study Material Orders (Total 1362)</h5>
                                            </div>
                                                    ...
                                                    <table className="display cell-border" id="export-button">
                                                        ...
                                                        <tbody>
                                                            <tr className="text-center">
                                                                ...
                                                                <td>App</td>
                                                                <td><i className="icofont icofont-cur-rupee"></i>3500</td>
...
export default studymaterialorders