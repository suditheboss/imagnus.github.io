      ...
      <div className="page-main-header">
        <div className="main-header-right">
          <div className="main-header-left text-center">
            <div className="logo-wrapper"><a href="dashboard.html"><img src="assets/images/logo/logo.png" alt="" className="logo"/></a></div>
          </div>
            ...
            <ul className="iconMenu-bar custom-scrollbar">
			  ...
			  <li className="active"><span className="badge badge-pill badge-primary">New</span>
			   <a className="bar-icons" href="javaScript:void(0)"><i className="pe-7s-cart"></i><span>Orders</span></a>
                <ul className="iconbar-mainmenu custom-scrollbar">
                  ...
                  <li><a href="allorders.html">MPPSC Civil Services</a></li>
				  <li><a href="studymaterialorders.html">MPPSC Forest Services</a></li>
				  <li><a href="testseriesorders.html">UPSC Civil Services</a></li>
				  <li><a href="testseriesorders.html"> One Day Exam Preparation</a></li>
			  ...
			  <li><a className="bar-icons" href="javaScript:void(0)"><i className="pe-7s-id"></i><span>Students</span></a>
                <ul className="iconbar-mainmenu custom-scrollbar">
                  ...
                  <li><a href="registrations.html">Student Registrations</a></li>
				  <li><a href="enquiries.html">Student Enquiries</a></li>
				  <li><a href="supporttickets.html">Support Tickets</a></li>
              ...
              <div className="row">
                ...
                <div className="col-lg-6 breadcrumb-right">
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item"><a href="dashboard.html"><i className="pe-7s-home"></i></a></li>
                    <li className="breadcrumb-item">General</li>
                    <li className="breadcrumb-item active">Course </li>
					<li className="breadcrumb-item active">Course Sub Category </li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div className="container-fluid">
			 <div className="row">
              ...
              <div className="col-xl-8 box-col-12">
                <div className="card height-equal">
                  <div className="card-header">
                     <h6><strong> Course Subcategory </strong></h6>
                  </div>
                     ...
                     <table className="display table table-border" id="export-button">
                        <thead>
                          <tr>
							...
							<th className="text-center">Course Topics</th>
                          </tr>
                        </thead>
                        <tbody>
                           <tr className="text-center">
                            <td>Paper First Part -A</td>
							<td>Polity | UNIT 4 Independence movement in Madhya Pradesh (मध्य प्रदेश में स्वतंत्रता आंदोलन) | History | UNIT - 5 Dynasties of Madhya Pradesh </td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
              ...
              <div className="col-xl-4 col-lg-12 col-md-6 box-col-6 debit-card">
                <div className="card height-equal">
                  <div className="card-header">
                    <h6><strong>Add Course Subcategory </strong></h6>
                  </div>
                  <div className="card-body">
                    <form className="theme-form e-commerce-form row">
                      ...
                      <div className="form-group col-12 p-r-0">
                        ...
                        <textarea className="form-control" type="text" row="5" placeholder="enter course preference title..."></textarea>
						<small><i>Enter multiple subjects with pipe (|) separated</i></small>
                      </div>
